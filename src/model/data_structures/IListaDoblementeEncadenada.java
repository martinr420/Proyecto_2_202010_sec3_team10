	...
	public interface IListaDoblementeEncadenada<K> extends Iterable<K> {
		...
		public K darUltimo();
		/**
		 * metodo que retorna un int con el tama�o de la lista
		...
		/**
		 * Elimina el ultimo nodo de la lista, reduce el tama�o de la lista y asigna el atributo
		...
		/**
		 * elimina el primer nodo de la lista, reduce su tama�o y 
		...
		/**
		 * Elimina el nodo en la posicion indicada, reduce el tama�o de la lista
		 * @param pPosicion
		 */
	 ...
	 */
		...
		public void cambiarNodoEnPos(int i, K pNodo);
